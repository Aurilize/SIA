...
?>
                            		<div class="x_panel">
                                		<div class="x_title">
                                			<h2>Laporan Ekstrakurikuler Siswa</h2>
                                    		<div class="clearfix"></div>
                                		</div>
                                		<div class="x_content">
                                    <!-- Smart Wizard -->
...
<?php
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        $view=mysql_query("SELECT siswa.nama_siswa, escoba.id_ekstra1, escoba.nilai1, escoba.id_ekstra2, escoba.nilai2, escoba.id_ekstra3, escoba.nilai3 FROM siswa, escoba, kelas_siswa WHERE kelas_siswa.id_siswa=siswa.id_siswa AND escoba.id_wk='$id_wk' AND escoba.id_kelassiswa=kelas_siswa.id_kelassiswa group by siswa.nama_siswa");
