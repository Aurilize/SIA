...
if(isset($_GET['id_mengajar'])){
    ...
    if($cek=='0'){
        ...
        ?><script language="javascript">document.location.href="input-peng?id_mengajar=<?php echo $id_mengajar?>&id_tahun=<?php echo $id_tahun ?>";</script><?php
    }else{
        //kalo sudah ada mode update
        ?><script language="javascript">document.location.href="update-peng?id_mengajar=<?php echo $id_mengajar?>&id_tahun=<?php echo $id_tahun ?>";</script><?php
    }
...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b>Laporan Penilaian</b></h3>
    </div></div><br />
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        $view=(mysql_query(
        	...
        	mapel.nama_mapel, 
        	kelas.nama_kelas,
        	bobot_peng.uh as b_uh, 
        	bobot_peng.th as b_th,
        	bobot_peng.uts as b_uts,
        	bobot_peng.uas as b_uas,
            tahun_ajar.id_tahun,
        ...
        <tr>
            ...
            <td><?php echo $row['b_uh'];?> : <?php echo $row['b_th'];?> : <?php echo $row['b_uts'];?> : <?php echo $row['b_uas'];?></td>
            <td><?php echo $row['semester'];?></td>
            <td><?php echo $row['tahun_ajaran'];?></td>
            <td><a href="lap-peng-siswa?id_mengajar=<?php echo $row['id_mengajar'];?>" style="text-decoration:underline" title="Pilih Mata Pelajaran">Nilai Pengetahuan</a></td>
            <td><a href="lap-tr-siswa?id_mengajar=<?php echo $row['id_mengajar'];?>" style="text-decoration:underline" title="Pilih Mata Pelajaran">Nilai Ketrampilan</a></td>
        </tr>
        <?php
        }
        ?>
