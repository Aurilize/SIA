...
<?php
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        $view=mysql_query("SELECT siswa.nama_siswa, prestasicoba.jenis_pres1, prestasicoba.keterangan1, prestasicoba.jenis_pres2, prestasicoba.keterangan2, prestasicoba.jenis_pres3, prestasicoba.keterangan3 FROM siswa, prestasicoba, kelas_siswa WHERE kelas_siswa.id_siswa=siswa.id_siswa AND prestasicoba.id_wk='$id_wk' AND prestasicoba.id_kelassiswa=kelas_siswa.id_kelassiswa group by siswa.nama_siswa");
