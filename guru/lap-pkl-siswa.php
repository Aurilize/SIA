...
?>
                            		<div class="x_panel">
                                		<div class="x_title">
                                			<h2>Laporan Praktik Kerja Lapangan Siswa</h2>
                                    		<div class="clearfix"></div>
                                		</div>
                                		<div class="x_content">
                                    <!-- Smart Wizard -->
...
<?php
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        $view=mysql_query("SELECT siswa.nama_siswa, pkl.tempat, pkl.lokasi, pkl.lama, pkl.ket FROM siswa, pkl, kelas_siswa WHERE kelas_siswa.id_siswa=siswa.id_siswa AND pkl.id_wk='$id_wk' AND pkl.id_kelassiswa=kelas_siswa.id_kelassiswa group by siswa.nama_siswa");
