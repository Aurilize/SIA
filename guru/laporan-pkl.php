...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b> Laporan Praktik Kerja Lapangan</b></h3>
    </div></div><br />
                                    <!-- Smart Wizard -->
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><a href="lap-pkl-siswa?id_wk=<?php echo $row['id_wk'];?>" style="text-decoration:underline" title="Pilih Siswa">Daftar Siswa</a></td>
        </tr>
        <?php
        }
        ?>
