...
if(isset($_GET['id_wk'])){
    ...
    $query=mysql_query("select * from ketidakhadiran where id_wk='$id_wk'");
    if ($query==FALSE){
        	die(mysql_error());
        }
    ...
    if($cek=='0'){
        ...
        ?><script language="javascript">document.location.href="input-absen?id_wk=<?php echo $id_wk?>";</script><?php
    }else{
        //kalo sudah ada mode update
        ?><script language="javascript">document.location.href="update-absen?id_wk=<?php echo $id_wk?>";</script><?php
    }
...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b>Absensi</b></h3>
    </div></div><br />
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><a href="absen-kelas?id_wk=<?php echo $row['id_wk'];?>" style="text-decoration:underline" title="Pilih Siswa">Daftar Siswa</a></td>
        </tr>
        <?php
        }
        ?>
