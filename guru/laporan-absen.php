...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b> Laporan Absensi</b></h3>
    </div></div><br />
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><a href="lap-absen-siswa?id_wk=<?php echo $row['id_wk'];?>" style="text-decoration:underline" title="Pilih Siswa">Daftar Siswa</a></td>
        </tr>
        <?php
        }
        ?>
