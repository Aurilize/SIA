...
if(isset($_POST['submit'])){
    ...
    for ($i=1; $i<=$jumSis; $i++)
    {
       ...
       $query = "insert into pengetahuan values('','$id_kelassiswa','$id_mengajar','$uh','$th','$uts','$uas')";
...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b>Input Nilai Pengetahuan</b></h3>
    </div></div><br />
                                    <!-- Smart Wizard -->
...
<?php
    ...
    <form  action="input-peng.php" method="post">
    <table table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><?php echo "<input type='text' name='uh".$i."' size='10'/>"; ?></td>
            <td><?php echo "<input type='text' name='th".$i."' size='10'/>"; ?></td>
