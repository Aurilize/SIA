...
if(isset($_POST['submit'])){
    ...
    for ($i=1; $i<=$jumSis; $i++)
    {
       ...
       $query = "insert into ketidakhadiran values('','$id_kelassiswa','$id_wk','$sakit','$ijin','$alpa')";
...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b>Input Absensi</b></h3>
    </div></div><br />
                                		<div class="x_content">
                                    <!-- Smart Wizard -->
...
<?php
    ...
    <form  action="input-absen.php" method="post">
    <table table class='table table-bordered responsive-utilities jambo_table'>
        ...
        $view=mysql_query(
            ...
            WHERE kelas_siswa.id_siswa=siswa.id_siswa AND 
                  ...
                  kelas_siswa.id_tahun=wali_kelas.id_tahun
        ...
        <tr>
            ...
            <td><?php echo "<input type='text' name='sakit".$i."' size='10'/>"; ?></td>
            <td><?php echo "<input type='text' name='ijin".$i."' size='10'/>"; ?></td>
            <td><?php echo "<input type='text' name='alpa".$i."' size='10'/>"; ?></td>
        </tr>
        <?php
            $i++;
        }
