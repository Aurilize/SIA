...
if(isset($_POST['submit'])){
    ...
    for ($i=1; $i<=$jumSis; $i++)
    {
       ...
       $query = "insert into ketrampilan values('','$id_kelassiswa','$id_mengajar','$pros','$prod','$proy')";
...
<body class="nav-md">
    <div class="container body">
        ...
        <h3 align="center"><b>Input Nilai Keterampilan</b></h3>
    </div></div><br />
                                    <!-- Smart Wizard -->
...
<?php
    ...
    <form  action="input-tr.php" method="post">
    <table table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><?php echo "<input type='text' name='pros".$i."' size='10'/>"; ?></td>
            <td><?php echo "<input type='text' name='prod".$i."' size='10'/>"; ?></td>
            <td><?php echo "<input type='text' name='proy".$i."' size='10'/>"; ?></td>
        </tr>
        <?php
            $i++;
        }
        ...
        <tr>
            <td colspan="7" align="center"><input type="submit" onclick="return confirm('Apakah Anda yakin?')" value="Input" name="submit"/></td>
        </tr>
