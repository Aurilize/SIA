...
<div class="clearfix"><div class="title">
        <h3 align="center"><b>Pengisian Nilai Pengetahuan</b></h3>
    </div></div><br />
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><a href="nilai-peng?id_mengajar=<?php echo $row['id_mengajar'];?>&id_tahun=<?php echo $row['id_tahun'];?>" style="text-decoration:underline" title="Pilih Mata Pelajaran">Nilai Pengetahuan</a></td>
        </tr>
        <?php
        }
        ?>
