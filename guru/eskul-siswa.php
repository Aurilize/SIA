...
<?php
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <tr>
            ...
            <td><a href="input-es?id_wk=<?php echo $row['id_wk'];?>&id_kelassiswa=<?php echo $row['id_kelassiswa'];?>" style="text-decoration:underline" title="Pilih Siswa">Isi Ekstrakurikuler</a></td>
        </tr>
        <?php
            $i++;
        }
