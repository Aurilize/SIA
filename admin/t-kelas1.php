...
if(isset($_POST['btn-save'])){
    ...
    if($crud->createKelas($nama_kelas)){
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12 input-group">
                                                <input type="text" class="form-control" name="kd_mapel" placeholder="Masukkan Bobot UH">
                                            </div>
                                        </div>
                                    <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">TH </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12 input-group">
                                                <input type="text" class="form-control" name="kd_mapel" placeholder="Masukkan Bobot TH">
                                            </div>
                                        </div>
                                    <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">UTS </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12 input-group">
                                                <input type="text" class="form-control" name="kd_mapel" placeholder="Masukkan Bobot UTS">
                                            </div>
                                        </div>
                                    <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">UAS </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12 input-group">
                                                <input type="text" class="form-control" name="kd_mapel" placeholder="Masukkan Bobot UAS">
